...
export class TipoComponent implements OnInit {
  ...
  load():Promise<void>{
    return new Promise((resolve) => {
      this.cadastroService.listarTipo(this.page, this.limit, this.search).subscribe({
        next: (res) => { 
  ...
  alterarAtivo($event, id : number){
    this.cadastroService.ativarTipo(id).subscribe(res =>{
  ...
  delete(id){
    ...
    .subscribe(res => {
    if (res) {
        this.cadastroService.deleteTipo(id).subscribe(res =>{
  ...
  save($event) {
    ...
    if(this.frmForm.invalid){
      ...
      this.loading = true;
        ...
        this.cadastroService.saveTipo(this.frmForm.value).subscribe(res =>{
