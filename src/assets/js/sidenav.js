                ...
                r = (function () {
                    function e(t) {
                        ...
                        if (
                            ...
                            (this._prevBtn = t.querySelector(".sidenav-horizontal-prev")),
                                this._prevBtn || ((this._prevBtn = document.createElement("a")), (this._prevBtn.href = "#"), (this._prevBtn.className = "sidenav-horizontal-prev"), s.appendChild(this._prevBtn)),
                                (this._wrapper = t.querySelector(".sidenav-horizontal-wrapper")),
                                this._wrapper || ((this._wrapper = document.createElement("div")), (this._wrapper.className = "sidenav-horizontal-wrapper"), this._wrapper.appendChild(this._inner), s.appendChild(this._wrapper)),
                                (this._nextBtn = t.querySelector(".sidenav-horizontal-next")),
                                this._nextBtn || ((this._nextBtn = document.createElement("a")), (this._nextBtn.href = "#"), (this._nextBtn.className = "sidenav-horizontal-next"), s.appendChild(this._nextBtn)),
                                (this._innerPosition = 0),
                                this.update();
                        } else {
                            t.classList.add("sidenav-vertical"), t.classList.remove("sidenav-horizontal");
                            var o = i || window.PerfectScrollbar;
                            o && (this._scrollbar = new o(t.querySelector(".sidenav-inner"), { suppressScrollX: !0, wheelPropagation: !0 }));
                        }
                    ...
                    return (
                        i(e, [
                            ...
                            //             this._horizontal && this._isRoot(i)
                            //                 ? (this._onOpen(this, i, s, this._findMenu(i)), this._toggleDropdown(!0, i, n), this._onOpened(this, i, s, this._findMenu(i)))
                            //                 : (this._animate
                            //                       ? (this._onOpen(this, i, s, this._findMenu(i)),
                            //                         window.requestAnimationFrame(function () {
                            //                             return t._toggleAnimation(!0, i, !1);
                            //                         }))
                            //                       : (this._onOpen(this, i, s, this._findMenu(i)), i.classList.add("open"), this._onOpened(this, i, s, this._findMenu(i))),
                            //                   this._accordion && this._closeOther(i, n));
                            //         }
                            //     },
                            // },
                            // {
                            ...
                            //                 this._onClose(this, i, s, this._findMenu(i)),
                            //                     window.requestAnimationFrame(function () {
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    var n = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2],
                                        ...
                                        s = this._getItem(e, !1);
                                    if (t && i) for (var o = this._el.querySelectorAll(".sidenav-inner .sidenav-item.active"), r = 0, l = o.length; r < l; r++) o[r].classList.remove("active");
                                    if (t && n) {
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    if (this._el) {
                                        this._unbindEvents();
                                        for (var e = this._el.querySelectorAll(".sidenav-item"), t = 0, n = e.length; t < n; t++)
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    var n = null,
                                        i = t ? "sidenav-toggle" : "sidenav-link";
                                    if ((e.classList.contains("sidenav-item") ? this._findChild(e, [i]).length && (n = e) : e.classList.contains(i) && (n = e.parentNode.classList.contains("sidenav-item") ? e.parentNode : null), !n))
                                        throw new Error((t ? "Toggable " : "") + "`.sidenav-item` element not found.");
                                    return n;
                                },
                            },
                            {
                                    ...
                                    for (var s = 0, o = (n = n.slice(0, n.indexOf(i))).length; s < o; s++)
                                        if ((n[s].classList.add("open"), this._accordion))
                                            for (var r = this._findChild(n[s].parentNode, ["sidenav-item", "open"]), l = 0, a = r.length; l < a; l++)
                                                if (r[l] !== n[s] && (r[l].classList.remove("open"), t)) for (var d = r[l].querySelectorAll(".sidenav-item.open"), h = 0, u = d.length; h < u; h++) d[h].classList.remove("open");
                                    return i;
                                },
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function (e, t, n) {
                                    ...
                                    e
                                        ? ((t.style.height = r + "px"),
                                          t.classList.add("sidenav-item-animating"),
                                          t.classList.add("open"),
                                          this._bindAnimationEndEvent(t, function () {
                                              l(), i._onOpened(i, t, s, o);
                                          }),
                                          setTimeout(function () {
                                              return (t.style.height = r + Math.round(o.getBoundingClientRect().height) + "px");
                                          }, 50))
                                        : ((t.style.height = r + Math.round(o.getBoundingClientRect().height) + "px"),
                                          t.classList.add("sidenav-item-animating"),
                                          t.classList.add("sidenav-item-closing"),
                                          this._bindAnimationEndEvent(t, function () {
                                              if ((t.classList.remove("open"), l(), n)) for (var e = t.querySelectorAll(".sidenav-item.open"), r = 0, a = e.length; r < a; r++) e[r].classList.remove("open");
                                              i._onClosed(i, t, s, o);
                                          }),
                                          setTimeout(function () {
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    ...
                                    (o = parseFloat(o) * (-1 !== o.indexOf("ms") ? 1 : 1e3)),
                                        (e._sideNavAnimationEndEventCb = i),
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    e._sideNavAnimationEndEventTimeout && (clearTimeout(e._sideNavAnimationEndEventTimeout), (e._sideNavAnimationEndEventTimeout = null)),
                                        t &&
                                    ...
                                    (this._evntElClick = function (t) {
                                        ...
                                        this._horizontal &&
                                            ...
                                            this._showDropdownOnHover &&
                                                ((this._evntInnerMousemove = function (t) {
                                                    ...
                                                    if (i && !i.classList.contains("open")) {
                                                        ...
                                                        s.length &&
                                                            (s[0].setAttribute("data-hover", "true"),
                                                            e.open(s[0], e._closeChildren, !0),
                                                            setTimeout(function () {
                                                ...
                                                (this._evntInnerMouseleave = function (t) {
                                                    e.closeAll();
                                                }),
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    this._evntElClick && (this._el.removeEventListener("click", this._evntElClick), (this._evntElClick = null)),
                                        ...
                                        this._evntPrevBtnClick && (this._prevBtn.removeEventListener("click", this._evntPrevBtnClick), (this._evntPrevBtnClick = null)),
                                        this._evntNextBtnClick && (this._nextBtn.removeEventListener("click", this._evntNextBtnClick), (this._evntNextBtnClick = null)),
                                        this._evntBodyClick && (document.body.removeEventListener("click", this._evntBodyClick), (this._evntBodyClick = null)),
                                        this._evntHorizontalElClick && (this._el.removeEventListener("click", this._evntHorizontalElClick), (this._evntHorizontalElClick = null)),
